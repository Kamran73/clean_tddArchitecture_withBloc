...
// in provider_state_management/test/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:provider_state_management/core/error/failures.dart' as _i6;
import 'package:provider_state_management/core/usecases/usecases.dart' as _i9;
...
class MockInputConverter extends _i1.Mock implements _i10.InputConverter {
  ...
  @override
  _i3.Either<_i6.Failures, int> stringToUnsignedInteger(
          {required String? str}) =>
      (super.noSuchMethod(
        Invocation.method(
