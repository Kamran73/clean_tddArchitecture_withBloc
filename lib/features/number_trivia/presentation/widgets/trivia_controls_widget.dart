...
class TriviaControlsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    void getConcreteTrivia(){
      BlocProvider.of<NumberTriviaBloc>(context).add(GetTriviaForConcreteNumber(numberString: triviaInputTextFieldController.text));
    }
      ...
      children: [
        SizedBox(
          ...
          child: TextField(
            ...
            onChanged: (value) {
              if(kDebugMode){
                print("the value of text field is: ${triviaInputTextFieldController.text}");
              }
            },
            onSubmitted: (value) {
              getConcreteTrivia();
